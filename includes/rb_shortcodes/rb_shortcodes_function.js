(function($){
	$(function() {
		...
		function insertButton(){
			var data = '[rb_button size="' + $('#rbButtonsSize').val() + '" style="' + $('#rbButtonsStyle').val() + '" link="' + $('#rbButtonsLink').val() + '" target="' + $('#rbButtonsTarget').val() + '" label="' + $('#rbButtonsLabel').val()+ '"] [/rb_button]';
			return data;
		}
		...
		function insertPricingTable(){
			...
			$('#rbPricingTable').children('div.boxes').children('div').each(function(){
				data += '[rb_table_column title="' + $(this).find('.rbPricingTableTitle').val() + '"]'
				data += '[rb_table_price]' + $(this).find('.rbPricingTablePrice').val() + '[/rb_table_price]';
