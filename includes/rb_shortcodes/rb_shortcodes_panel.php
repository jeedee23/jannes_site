...
<head>
	<title><?php _e("Insert Shortcode", 'corvius'); ?></title>
	...
	<div>
		<div class="clean">
			...
			<select id="rbShortcodeType">
				...
				<option data-id="#rbContrast">Contrast Container</option>
				<option data-id="#rbDivider">Divider</option>
				<option data-id="#rbDropcap">Dropcap</option>
				<option data-id="#rbMaps">Google Map</option>
				<option data-id="#rbMark">Highlighted Text</option>
				<option data-id="#rbIconButton">Icon Button</option>
				<option data-id="#rbIconBlock">Icon Text Block</option>
				<option data-id="#rbImage">Image (lightbox)</option>
				<option data-id="#rbList">List</option>
				<option data-id="#rbNumericBlock">Numeric Text Block</option>
				<option data-id="#rbPricingTable">Pricing Table</option>
				<option data-id="#rbPostList">Posts Box</option>
				<option data-id="#rbQuote">Quote</option>
				<option data-id="#rbTabs">Tabs</option>
				<option data-id="#rbTable">Table</option>
				<option data-id="#rbTeam">Team List</option>
				<option data-id="#rbTextBox">Text Box</option>
				<option data-id="#rbTestimonials">Testimonials</option>
		...
		<div id="rbShortcodePanels" class="clean panels">
			...
			<div data-type="button" id="rbButtons">
				<p>Button</p>
				<div class="field">
					<label for="rbButtonsSize">Size:</label>
					<select id="rbButtonsSize">
						<option>small</option>
			...
			<div data-type="postBox" id="rbPostList">
				...
				<div class="field">
					<label for="rbPostsTag">Posts category/tag:</label>
			...
			<div data-type="textBox" id="rbTextBox">
				...
				<div class="field">
					<label for="rbTextBoxStyle">Style:</label>
					<select id="rbTextBoxStyle">
						<option>light</option>
						<option>dark</option>
					</select>
				</div>
		...
		<div class="clean">
			...
			<div class="mceActionPanel" style="overflow: hidden; margin-top: 20px;">
				<div style="float: left">
					<input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'corvius'); ?>" onclick="tinyMCEPopup.close();" class="button" />
				</div>
				...
				<div style="float: right">
					<button id="previewCode" value="<?php _e("Preview", 'corvius'); ?>" class="button" type="button"><?php _e("Preview", 'corvius'); ?></button>
				</div>
			</div>
		</div>
