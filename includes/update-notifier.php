...
define( 'NOTIFIER_THEME_NAME', 'Corvius' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'corvius' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.rubenbristian.com/content/themeUpdates/corvius-notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 86400 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
